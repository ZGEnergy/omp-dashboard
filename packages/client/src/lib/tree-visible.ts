 ...
 * Best-effort read/write; defaults to visible.
 *
...
/** Read persisted visibility; default (visible) on absence/corruption. */
...
/** Session-scoped tree visibility. Loads on mount / session change; persists on set. */
