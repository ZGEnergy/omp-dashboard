...
| `session-replay-ledger.ts` | Canonical logical replay ledger. Validates exact events plus skipped ranges, source generation, overlap, conflict, and continuity. Tracks logical min/cursor without materializing omitted sequence IDs. Enforces 10 MiB hot tail. See change: tool-burst-hydration. |
