...
import { BuiltInRolesSettings } from "/home/skrot1/BB/pi-packages/pi-agent-dashboard/packages/builtins-plugin/src/index";
import { FlowActivityBadgeClaim, SessionFlowActionsClaim, shouldRenderFlowsSubcard, FlowDashboardClaim, FlowArchitectClaim, FlowYamlPreviewClaim, isFlowYamlPreviewActive } from "/home/skrot1/BB/pi-packages/pi-agent-dashboard/packages/flows-plugin/src/client/index";
...
export const PLUGIN_REGISTRY: RegistryEntry[] = [
  {
    manifest: {
        "id": "builtins",
        "displayName": "Dashboard Built-ins",
        "priority": 100,
        "claims": [
            {
    ...
    claims: [
      { pluginId: "builtins", priority: 100, slot: "settings-section", tab: "general", Component: BuiltInRolesSettings },
    ],
  },
  {
    manifest: {
