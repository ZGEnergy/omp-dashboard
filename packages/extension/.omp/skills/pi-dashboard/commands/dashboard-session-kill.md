...
Task: resolve the id-prefix. This is DESTRUCTIVE — the session process is terminated. Confirm with the user, then POST /api/session/<full-id>/shutdown with body {}. Report the result.
