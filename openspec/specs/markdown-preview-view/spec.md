...
The MarkdownPreviewView SHALL be a reusable component that renders markdown content with a back button, an optional title, and an optional tab bar. It SHALL use the existing MarkdownContent component for rendering.
