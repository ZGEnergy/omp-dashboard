# ws-broadcast-load-harness Specification

## Purpose

Deterministic load harness modeling WebSocket broadcast backpressure, cross-cwd leak, and focused-message latency signatures against the real browser gateway.
