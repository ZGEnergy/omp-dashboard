# openspec-change-order Specification

## Purpose

Persisted manual ordering of changes within each group (including the implicit Ungrouped group). Order survives reload, is broadcast like group/assignment changes, falls back to deterministic default sort when absent, and follows changes when reassigned between groups.
