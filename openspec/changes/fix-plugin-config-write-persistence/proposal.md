...
- **Plugins:** none — `flows`, `automation`, `jj`, etc. persist automatically once the interception lands; `subagents`' mirror hook starts firing on UI saves.
