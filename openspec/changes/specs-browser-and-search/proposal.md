...
- **Add fuzzy text search to MarkdownPreviewView**: A reusable fuse.js-powered search overlay that highlights matches in rendered markdown and provides prev/next navigation. Available in any markdown preview, including the new specs browser.

## Capabilities

### New Capabilities
- `specs-browser`: Browsing main OpenSpec specs from the dashboard with concatenated view, combobox jump-to, and scroll anchors
- `markdown-fuzzy-search`: Reusable fuzzy text search overlay for MarkdownPreviewView using fuse.js
...
- **Dependencies**: Add `fuse.js` npm package
