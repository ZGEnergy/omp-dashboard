...
- [ ] 2.3 Manual: `cd packages/electron && npm start` — splash appears immediately, status progresses, closes when main window ready _(operator gate)_
- [ ] 2.4 Manual Windows smoke: launch packaged .exe cold, confirm splash visible within 1s with progressing status text _(operator gate)_

## 3. Spec sync

- [ ] 3.1 Update `openspec/specs/electron-shell/spec.md` with splash lifecycle requirements (after validation passes)
